  ...
  return (
    <section id="contact" className="scroll-mt-20 bg-gradient-to-br from-brand via-brand-dark to-brand-deep py-20 text-white sm:py-28">
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6">
        <Reveal>
          <h2 className="font-display text-[clamp(2.2rem,5.5vw,4rem)] leading-tight font-extrabold">
            {t('আজই অর্ডার করুন', 'Order Today')}
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-white/85">
            {t(
              'আপনার খামারের পুষ্টি নিশ্চিত হোক আজই। সঠিক পুষ্টিগুণ ও নিখুঁত এয়ারটাইট প্যাকেজিংয়ে এ কে সাইলেজ পৌঁছে যাবে সরাসরি আপনার খামারে।',
              'Secure your farm’s nutrition today. With the right nutrients and precise airtight packaging, AK Silage is delivered straight to your farm.'
            )}
          </p>
        </Reveal>
        ...
        <Reveal delay={0.15}>
          <a
            ...
            className="mt-9 inline-flex items-center gap-3 rounded-full bg-white px-9 py-4 font-display text-xl font-extrabold text-brand shadow-2xl shadow-black/25 transition-colors duration-200 hover:bg-paper sm:px-12 sm:text-2xl"
          >
        ...
        <Reveal delay={0.25}>
          <div className="mx-auto mt-12 grid max-w-3xl gap-4 text-left sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/20 bg-white/10 p-6 backdrop-blur-sm">
              ...
              <p className="mt-1.5 text-[15px] leading-relaxed text-white/80">
                {t(
                  'সারাদেশে কুরিয়ারে ডেলিভারি। পাইকারি অর্ডারে বিশেষ মূল্য।',
                  'Courier delivery nationwide. Special pricing on wholesale orders.'
                )}
              </p>
            </div>
          </div>
